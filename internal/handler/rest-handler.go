...
func NewRestHandler(srv *service.ServiceFlightSolution) *RestHandler {
...
func (s *RestHandler) FlightHandler() http.Handler {
...
func (s *RestHandler) GetFlights(w http.ResponseWriter, r *http.Request) {
	start := time.Now()
	...
	date, err := ParseStringDepartureDateToRFC(body.DepartureDate)
	if err != nil {
